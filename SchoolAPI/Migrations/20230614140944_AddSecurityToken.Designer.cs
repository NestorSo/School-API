...
namespace SchoolAPI.Migrations
{
    ...
    [Migration("20230614140944_AddSecurityToken")]
    partial class AddSecurityToken
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SchoolAPI.Models.Student", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            StudentId = 2,
                            DateOfBirth = new DateTime(2017, 4, 12, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            GradeId = 2,
                        ...
                        {
                            StudentId = 3,
                            DateOfBirth = new DateTime(2019, 1, 28, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            GradeId = 2,
                            StudentName = "Carlos Fonseca"
                        });
                });

            modelBuilder.Entity("SchoolAPI.ModelsUser.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
